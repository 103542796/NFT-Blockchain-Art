...
<a href="../main/discoverpage.php" class="goingback"> <i class="bi bi-arrow-90deg-left"></i> Back </a>
    ...
    <div class="heading"> 
        <h4 class="history"> Expressionism Art </h4>
    </div>
    ...
    <div class="container">
        <?php 
            ...
            $sql_recent = "SELECT * FROM product WHERE product.attribute LIKE '%Expressionism%'
        ...
        <?php
            ...
            WHERE product.attribute LIKE '%Expressionism%'";
            ...
            if ($currentPage > 1) {
                echo '<a href="expressionism.php?page=' . ($currentPage - 1) . '">Previous</a>';
            } 
            for ($i = 1; $i <= $total_pages; $i++) {
                echo '<a ' . ($i == $currentPage ? 'class="active"' : '') . ' href="?page=' . $i . '">' . $i . '</a>';
            }
            if ($currentPage < $total_pages) {
                echo '<a href="expressionism.php?page=' . ($currentPage + 1) . '">Next</a>';
            }
        ?>
        </div>
